...
| `formatHumanWhatsAppText` / `agentAttendingLine`                           | `server/whatsapp-agent-intro.ts`                                | Prefixar respostas humanas no WhatsApp com o nome do atendente (`*Lucas* está te atendendo`) acima do corpo. Usar no envio manual de texto/legenda; não aplicar em respostas da IA.                                                                                                 |
