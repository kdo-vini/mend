...
| `runMendCatalogDeleteFlow` / catalog-client                                       | `server/integrations/zelopdv-gerente/`                          | Fluxo nativo do Mend: buscar/preparar/excluir via API M2M do ZeloPDV e confirmação Sim/Não na própria conversa. Não reutiliza a persona do Zelinho Gerente.                                                                                                                                              |
